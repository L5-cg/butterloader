...
butterLoader.Parent = game.Players.LocalPlayer:WaitForChild("CoreGui")
...
local function TLSHN_fake_script() -- submit.Handler 
...
coroutine.wrap(TLSHN_fake_script)()
local function RMFJ_fake_script() -- submit.LocalScript 
	local script = Instance.new('LocalScript', submit)
...
coroutine.wrap(RMFJ_fake_script)()
local function YHPRHFE_fake_script() -- join.Handler 
...
coroutine.wrap(YHPRHFE_fake_script)()
local function MDWNVOZ_fake_script() -- close.LocalScript 
...
coroutine.wrap(MDWNVOZ_fake_script)()
